...
- [正确设置open_cursors和'session_cached_cursors'  可以减少sql解析，提高系统性能，那么，如何正确设置'session_cached_cursors'  这个参数呢？我们可以把握下面的原则](#正确设置open_cursors和session_cached_cursors-可以减少sql解析提高系统性能那么如何正确设置session_cached_cursors-这个参数呢我们可以把握下面的原则)
